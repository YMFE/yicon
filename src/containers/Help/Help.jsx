          ...
          <main className={`spec-content ${type === 'draw' ? 'on' : ''}`}>
            ...
            <ul className="spec-detail">
              <li className="item">
                ...
                <div className="spec-img-box spec-img-draw01">
                </div>
                <div className="spec-img-box spec-img-draw02">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-draw03">
                </div>
                <div className="spec-img-box spec-img-draw04">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-draw05">
                </div>
                <div className="spec-img-box spec-img-draw06">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box width spec-img-draw07">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box width spec-img-draw08">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box width spec-img-draw09">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-draw10">
                </div>
                <div className="spec-img-box spec-img-draw11">
                </div>
              </li>
            </ul>
          </main>
          <main className={`spec-content ${type === 'style' ? 'on' : ''}`}>
            ...
            <ul className="spec-detail">
              <li className="item">
                ...
                <div className="spec-img-box spec-img-box01">
                </div>
                <div className="spec-img-box spec-img-box02">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-box03">
                </div>
                <div className="spec-img-box spec-img-box04">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-box05">
                </div>
                <div className="spec-img-box spec-img-box06">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-box07">
                </div>
                <div className="spec-img-box spec-img-box08">
                </div>
              </li>
              <li className="item">
                <div className="spec-info">
                ...
                <div className="spec-img-box spec-img-box09">
                </div>
                <div className="spec-img-box spec-img-box10">
                </div>
              </li>
            </ul>
          </main>
